...
router.get("/lib/book/:num", (req, res, next) => {
    ...
    res.render("originbook",{author:book[id].author,title: book[id].title,date: book[id].date,state: book[id].in_library, bookid: id,userfolder: user,date_return: book[id].date_return})
    next();
});
